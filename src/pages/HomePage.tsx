...
import { Search, Bus, Navigation, Zap, Clock, Bell, Shield, Users, ChevronRight } from "lucide-react";
          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-2xl leading-relaxed">
                Never miss your bus again! Search by route or track specific buses with live updates, accurate ETAs, and smart notifications.
              </p>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    ...
                    onChange={(e) => setSearchFilters(prev => ({ ...prev, busNumber: e.target.value }))}
            ...
            {[
              {
                ...
                title: "Smart Search",
                description: "Find buses by route or number with intelligent filtering and suggestions",
                color: "from-yellow-400 to-orange-500",
              },
              {
                icon: <Clock className="w-8 h-8" />,
                title: "Real-Time Tracking",
                description: "Live location updates with GPS precision and accurate ETA calculations",
                color: "from-blue-400 to-blue-600",
              },
              {
                icon: <Bell className="w-8 h-8" />,
                title: "Smart Alerts",
                description: "Personalized notifications to ensure you never miss your bus",
                color: "from-green-400 to-green-600",
              },
              {
                icon: <Shield className="w-8 h-8" />,
                title: "Reliable Service",
                description: "99.9% uptime with enterprise-grade infrastructure and monitoring",
                color: "from-purple-400 to-purple-600",
              },
              {
                icon: <Users className="w-8 h-8" />,
                title: "Community Driven",
                description: "Real-time updates from drivers and passengers for better accuracy",
                color: "from-pink-400 to-pink-600",
              },
              {
                icon: <Zap className="w-8 h-8" />,
                title: "Lightning Fast",
                description: "Optimized performance with instant search results and updates",
              ...
              >
                <div className={`absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-300 blur-xl rounded-2xl bg-gradient-to-r ${feature.color}`}></div>
                <div className="relative bg-white/30 dark:bg-white/5 backdrop-blur-2xl border border-white/30 dark:border-white/10 rounded-2xl p-8 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
                  <div className={`inline-flex p-3 rounded-2xl bg-gradient-to-r ${feature.color} text-white mb-6 shadow-lg`}>
                    {feature.icon}
                  </div>
